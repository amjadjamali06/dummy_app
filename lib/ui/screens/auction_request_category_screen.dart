...
class AuctionRequestCategoryScreen extends GetView<AuctionRequestCategoryScreenController> {
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Auction Request",style: GoogleFonts.montserrat(fontSize: 25,fontWeight: FontWeight.w500),),
            const SizedBox(height: 20),
            auctionRequestCategoryCard(cardName: "PLATINUM",text: "AAA",iconPath: 'assets/images/paltinum.png',  onTap: (){}),
            const SizedBox(height: 20),
            auctionRequestCategoryCard(cardName: "GOLD",text: "AAAAA", iconPath: 'assets/images/gold.png', onTap: (){}),
            const SizedBox(height: 20),
            auctionRequestCategoryCard(cardName: "SILVER",text: "AAAAAAA", iconPath: 'assets/images/silver.png', onTap: (){}),
          ],
        ),
      ),
    );
  ...
  Widget auctionRequestCategoryCard({String cardName="",String text="", String iconPath='', required Function() onTap}){
